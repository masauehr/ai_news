...
"""
haiku_agent.py — Claude Haiku (Anthropic API) で ai_news 記事を自動生成する
...
# ------------------------------------------------------------------ #
# ツール定義（Anthropic SDK format: input_schema を使用）
# ------------------------------------------------------------------ #
    ...
    },
    {
        ...
        "input_schema": {
            ...
            "properties": {
                "path": {
                    "type": "string",
                    "description": "書き込み先（例: articles/haiku_weekly/2026-0525.md）",
                },
                "content": {
                    "type": "string",
    ...
    },
    {
        ...
        "input_schema": {
            ...
            "properties": {
                ...
                "week_path": {
                    "type": "string",
                    "description": "週次記事の相対パス（例: ./articles/haiku_weekly/2026-0525.md）",
                },
            },
...
def tool_append_to_readme(week_label: str, week_path: str) -> str:
    """README.md の '### Haiku週次まとめ' セクションに週次リンクを追加する"""
...
def tool_update_index(week_label: str, week_path: str) -> str:
    """index.md の Haiku セクションと haiku_weekly/index.md を更新する"""
    ...
    # 1. トップページ (index.md) — Haiku セクションを更新
...
def main():
    parser = argparse.ArgumentParser(description="ai_news Haiku エージェント（Anthropic API）")
    ...
    if not os.environ.get("ANTHROPIC_API_KEY"):
        ...
        log("  export ANTHROPIC_API_KEY=sk-ant-... を実行するか")
