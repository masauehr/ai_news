...
### 松尾公也 — iPhone Airだけで動くAI音声対話アプリをClaude Codeが一晩で開発（4/15）

Techno Edgeシニアエディターの松尾公也氏が、iPhone Air（A19 Pro・12GB RAM）向けの完全オンデバイス音声対話AIアプリ「AvaTalk」をClaude Codeで一晩開発した実録レポート。llama.cppのiOSビルド・SFSpeechRecognizer・SwiftUIを組み合わせ、ネット接続不要の音声対話を実現。iOSのセキュリティ制限でMacBook Neoよりアプリ使用可能RAMが少ない"逆転現象"など、エッジAI開発のリアルが詰まっている。

参照: [iPhone Airだけで動くAI音声対話アプリをClaude Codeが開発（Techno Edge / 松尾公也、4/15）](https://www.techno-edge.net/article/2026/04/15/4990.html)

### 松尾公也 — Claude Codeで3D Gaussian SplatをMacBook NeoのビジュアライザーへDIY統合（4/16）

8GBメモリのMacBook Neoで、SparkJS（オープンソースGaussian Splatライブラリ）と既存の音楽ビジュアライザーをClaude Codeを使って500〜600行追加するだけで統合した実験記事。ベース・ボーカル・高音ごとにスプラット雲を分けて曲に同期させた「目まぐるしくも不思議なMV」が完成するまでの試行錯誤を詳述。「Three.jsが書ける人なら誰でもGaussian Splatを扱える」という実感が伝わる。

参照: [Claude Codeで自作ビジュアライザーに3D Gaussian Splatを組み込み（Techno Edge / 松尾公也、4/16）](https://www.techno-edge.net/article/2026/04/16/4992.html)

---

## 📝 Note 注目記事（個人体験・一次レポート）

### こわっきー — 「生成AIはPCよりスマホより速く普及した」（Stanford AI Index 2026 解説）

Stanford AI Index 2026を受けての現場目線解説。普及速度・業務実態・日本の課題を整理。スペックではなく「使っている人間の側」からAI普及を読み解く視点が光る。

参照: [note / こわっきー](https://note.com/kowackey13824/n/nb4e5974a0f99)

### 小泉成文 — AI関連のライトな話（2026年4月時点）（4/12）

画像・動画生成AIを実際に触った生の印象をまとめた個人記事。「動画はKlingが頭一つ抜けてクオリティ高く、SoraはLumaAIと比べても相当出遅れている」など忖度なしの一次評価が読み応えあり。主要チャットAI（Claude・ChatGPT・Gemini）の使い分けについても「Claudeは業務全般、ChatGPTは言語学習、Geminiはその他」という実践的整理を提示。

参照: [AI関連のライトな話（2026年4月時点）（note / 小泉成文、4/12）](https://note.com/nari4d/n/n56a5db1a223e)
...
今号から Techno Edge と note の個人体験記事を積極的に収録した。松尾公也氏によるiPhoneアプリ一晩開発レポートは、スペックやベンチマーク記事では得られない「実際どうなのか」が詰まっており、今後も Techno Edge は定点観測していきたい。note は総説より「試した・作った」系の一次体験記事を優先して拾っていく方針に変更している。
